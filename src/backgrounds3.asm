...
draw_loop:
    LDA tilemap3, Y   ; Load value from tilemap2 at index Y
    STA current_tile2
    JSR draw_tiles

    INY             ; Increment Y to move to the next index
    CPY #$10        ; Compare Y to 8 (end condition)
    BNE draw_loop   ; Branch back to draw_loop if Y is not equal to 8
...
draw_loop2:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$20        ; Compare Y to 8 (end condition)
    BNE draw_loop2   ; Branch back to draw_loop if Y is not equal to 8
...
draw_loop3:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$30        ; Compare Y to 8 (end condition)
    BNE draw_loop3   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$29
    STA nam_pos2
...
draw_loop4:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$40        ; Compare Y to 8 (end condition)
    BNE draw_loop4   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$40   ; Starting map position
    STA map_pos2
    LDY #$40
draw_loop5:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$50        ; Compare Y to 8 (end condition)
    BNE draw_loop5   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$80   ; Starting map position
    STA map_pos2
    LDY #$50
draw_loop6:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$60        ; Compare Y to 8 (end condition)
    BNE draw_loop6   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$c0   ; Starting map position
    STA map_pos2
    LDY #$60
draw_loop7:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$70        ; Compare Y to 8 (end condition)
    BNE draw_loop7   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$2a
    STA nam_pos2
    LDA #$00   ; Starting map position
    STA map_pos2
...
draw_loop8:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$80        ; Compare Y to 8 (end condition)
    BNE draw_loop8   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$40   ; Starting map position
    STA map_pos2
    LDY #$80
draw_loop9:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$90        ; Compare Y to 8 (end condition)
    BNE draw_loop9   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$80   ; Starting map position
    STA map_pos2
    LDY #$90
draw_loop10:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$a0        ; Compare Y to 8 (end condition)
    BNE draw_loop10   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$c0   ; Starting map position
    STA map_pos2
    LDY #$a0
draw_loop11:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$b0        ; Compare Y to 8 (end condition)
    BNE draw_loop11   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$2b
    STA nam_pos2
    LDA #$00   ; Starting map position
    STA map_pos2
...
draw_loop12:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$c0        ; Compare Y to 8 (end condition)
    BNE draw_loop12   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$40   ; Starting map position
    STA map_pos2
    LDY #$c0
draw_loop13:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$d0        ; Compare Y to 8 (end condition)
    BNE draw_loop13   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$80   ; Starting map position
    STA map_pos2
    LDY #$d0
...
buoy_tile:
    LDA buoy, X        ; Load buoy tile data
    JMP draw_tile_data ; Jump to draw_tile_data

buoyWall_tile:
	LDA buoyWall, X        ; Load buoy tile data
	JMP draw_tile_data ; Jump to draw_tile_data

jellyfish_tile:
    LDA jellyfish, X       ; Load crate tile data
    JMP draw_tile_data ; Jump to draw_tile_data

tentacle_tile:
    LDA tentacle, X     ; Load tentacle tile data
    JMP draw_tile_data ; Jump to draw_tile_data

leftTop_tile:
    LDA leftTop, X     ; Load tentacle tile data
    JMP draw_tile_data ; Jump to draw_tile_data

rightTop_tile:
    LDA rightTop, X     ; Load tentacle tile data
    JMP draw_tile_data ; Jump to draw_tile_data

leftBottomBuoy_tile:
    LDA leftBottomBuoy, X     ; Load tentacle tile data
    JMP draw_tile_data ; Jump to draw_tile_data

rightBottomBuoy_tile:
    LDA rightBottomBuoy, X     ; Load tentacle tile data
    JMP draw_tile_data ; Jump to draw_tile_data
...
draw_loop:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$08        ; Compare Y to 8 (end condition)
    BNE draw_loop   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$80   ; Starting map position
    STA map_pos2
    LDY #$08
...
draw_loop3:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$18        ; Compare Y to 8 (end condition)
    BNE draw_loop3   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$2d
    STA nam_pos2
    LDA #$00   ; Starting map position
...
draw_loop5:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$28        ; Compare Y to 8 (end condition)
    BNE draw_loop5   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$80   ; Starting map position
    STA map_pos2
    LDY #$28
...
draw_loop7:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$38        ; Compare Y to 8 (end condition)
    BNE draw_loop7   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$2e
    STA nam_pos2
    LDA #$00   ; Starting map position
...
draw_loop9:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$48        ; Compare Y to 8 (end condition)
    BNE draw_loop9   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$80   ; Starting map position
    STA map_pos2
    LDY #$48
...
draw_loop11:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$58        ; Compare Y to 8 (end condition)
    BNE draw_loop11   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$2f
    STA nam_pos2
    LDA #$00   ; Starting map position
...
draw_loop13:
    ...
    INY             ; Increment Y to move to the next index
    CPY #$68        ; Compare Y to 8 (end condition)
    BNE draw_loop13   ; Branch back to draw_loop if Y is not equal to 8
    LDA #$80   ; Starting map position
    STA map_pos2
    LDY #$68

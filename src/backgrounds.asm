...
leftCorner_tile:
    LDA leftCorner, X     ; Load seaweed tile data
    JMP draw_tile_data ; Jump to draw_tile_data

rightCorner_tile:
    LDA rigthCorner, X     ; Load seaweed tile data
    JMP draw_tile_data ; Jump to draw_tile_data

leftBottom_tile:
    LDA leftBottom, X     ; Load seaweed tile data
    JMP draw_tile_data ; Jump to draw_tile_data

rightBottom_tile:
    LDA rightBottom, X     ; Load seaweed tile data
    JMP draw_tile_data ; Jump to draw_tile_data
